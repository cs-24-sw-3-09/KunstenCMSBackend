...
public class DisplayDeviceControllerIntegrationTests {
    ...
    public void testThatSetFallbackContentToSlideShowSetsFallbackContentToSlideShow() throws Exception {
        ...
        mockMvc.perform(
                        MockMvcRequestBuilders.patch("/api/display_devices/" + savedDisplayDeviceEntity.getId() + "/fallbackContent")
                                .contentType(MediaType.APPLICATION_JSON)
                ...
                .andExpect(
                        MockMvcResultMatchers.jsonPath("$.fallbackContent.isArchived").value(savedSlideshowEntity.getIsArchived()));
    ...
    public void testThatSetFallbackContentToVisualMediaSetsFallbackContentToVisualMedia() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(
                        MockMvcResultMatchers.jsonPath("$.fallbackContent.location").value(savedVisualMedia.getLocation()))
                .andExpect(
                        MockMvcResultMatchers.jsonPath("$.fallbackContent.fileType").value(savedVisualMedia.getFileType()));
